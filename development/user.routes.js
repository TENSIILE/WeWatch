...
router.get('/getInfo/email', auth, isExistUser, isCloseProfile, async (req, res) => {
    try {
...
router.get('/getInfo/fullInformation', auth, isExistUser, isCloseProfile, async (req, res) => {
    try {
