    ...
    return (
        ...
        >
                        ...
                        messages.map((message, i) => {
                            return (
                                <React.Fragment key={i}>
                                    {
                                        logicChat.renderStickyDate(message.create_at, messages[restrictOutsidePlaybackground(i)].create_at) &&
                                        <span className='sticky-date'>{new Date(message.create_at).toLocaleDateString()}</span> 
                                    }
            ...
            >
                ...
                <Badge 
                    newClass={'badge-count'} 
                    text={logicChat.countUnreadMsg}
                />
            </div>
        </div>
    )
