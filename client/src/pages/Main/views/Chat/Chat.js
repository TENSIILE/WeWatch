    ...
    <>
      ...
      <div className='container-chat'>
        {!!main.infoUserDialogs.length || main.infoUserDialogs.length === 0 ? (
          !!logicChat.urlParams.id &&
          !!Object.keys(logicChat.currentDialog).length ? (
            <>
              <ChatHeader
                logo={logicChat.currentDialog.userAdditional.avatar}
                title={
                  logicChat.currentDialog.userAdditional.name +
                  ' ' +
                  logicChat.currentDialog.userAdditional.lastname
                }
