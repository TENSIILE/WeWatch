...
export const SettingItems = () => {
    const [settingItem] = useState([
        ...
        {title:'Конфиденциальность', icon:confidentiality, type:CONFIDENTIALITY},
        ...
        // {title:'Уведомления', icon:notification, type:NOTIFICATION, disabled:true},
        {title:'Горячие клавиши', icon:keyboard, type:KEYBOARD},
        // {title:'Языки', icon:languages, type:LANGUAGES, disabled:true},
    ...
    return (
        <>
            ...
            <ul className='settings-list beautiful-scrollbar mini'>
                {
                    searcher.array.length ? searcher.array.map((item, i) => {
