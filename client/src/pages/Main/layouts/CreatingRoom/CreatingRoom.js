      ...
      <div className='body-room-customization beautiful-scrollbar'>
        ...
        <div className='setup-logo-room'>
          ...
          <input
            type='file'
            id='logo-room'
            ref={logic.refUploadLogo}
            name='logo-room'
            onChange={logic.uploadLogoRoomLocal}
          ...
          <label
            ...
            style={{
              height: logic.urlLogoRoom ? '500px' : 0,
              marginBottom: logic.urlLogoRoom ? '2em' : 0,
            }}
            htmlFor='logo-room'
          >
            <ReactSVG src={photo} />
        ...
        <InviteFriend listFriend={logic.listAddedFriends} />
        ...
        <div className='link-to-video'>
          ...
          <div className='preview'>
            <img
              src={`//img.youtube.com/vi/${logic.getPreviewFromLink()}/maxresdefault.jpg`}
              alt=''
            />
          </div>
        </div>
