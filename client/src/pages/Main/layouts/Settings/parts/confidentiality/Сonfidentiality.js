                ...
                <li className='clause'>
                    <div className="tuning-control">
                        <div className="text-info-detail">
                            ...
                            <span className='description'>Закрытый профиль позволяет запретить просмотр информации в Вашем профиле</span>
                        </div>
                        <SwitchBtn 
                            size='mini'
                            id='close-profile' 
                ...
                <li className='clause'>
                    <div className="tuning-control direction-column">
                        <div className="text-info-detail">
                            ...
                            <span className='description'>Изменив данный пункт на "Все", любой пользователь WeWatch сможет отправить Вам запрос в друзья. При выбранном пункте "Никто", больше ни один пользователь не сможет добавиться к Вам в друзья.</span>
                        </div>
                        <Radio.Container>
                            <Radio 
                                text='Все' 
