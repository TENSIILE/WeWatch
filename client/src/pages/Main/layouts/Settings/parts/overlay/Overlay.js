    ...
    return (
        <div className='overlay'>
            <ul className="clauses-tining">
                ...
                <li className='clause'>
                    <div className="tuning-control">
                        <div className="text-info-detail">
                            ...
                            <span className='description'>Включенный оверлей позволит Вам смотреть видеоролики поверх любых страниц</span>
                        </div>
                        <SwitchBtn 
                            size='mini'
                            id='overlay' 
                ...
                <li 
                    className={classnames("clause transition overflow-h", {'hidden': !settings.switchBtn[OVERLAY]})} 
