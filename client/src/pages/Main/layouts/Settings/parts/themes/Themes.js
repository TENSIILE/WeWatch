    ...
    <div className='themes'>
      <ul className='clauses-tining'>
        ...
        <li className='clause background-for-chat'>
          ...
          <div
            className={classnames('background-for-chat', {
              visible: settings.switchBtn[BACKGROUND_FOR_CHAT],
            })}
          >
        ...
        <li className='clause'>
          <div className='tuning-control'>
            <div className='text'>
              ...
              <BadgeMini text='Новое' newClass='danger' />
            </div>
          </div>
          <div
            className={classnames('custom-themes', {
              'hidden-cubes': settings.switchBtn[CONFRONTATION_WITH_DARK_THEME],
            })}
          >
            <div className='cubes'>
              {settings.cubes.map((cube, i) => {
                return (
                  <CubeTheme key={i} {...cube} onClick={settings.changeTheme} />
                )
              })}
            </div>
          </div>
          ...
          <div
            className={classnames(
              'tuning-control with-description confrontation',
              { visible: settings.switchBtn[DARK_THEMES] }
            )}
          ...
          >
            <div className='tuning-control__wrapper-column'>
              <div className='text-info-detail'>
                ...
                <span className='description'>
                  При включении данного пункта все элементы приложения будут
                  приведены к темной теме
                </span>
              </div>
              <SwitchBtn
                size='mini'
                ...
                onChange={() =>
                  settings.changeSwitchBtn(CONFRONTATION_WITH_DARK_THEME)
                }
            ...
            <div className='tuning-control__wrapper-column'>
              <div className='text-info-detail'>
                ...
                <span className='description'>
                  Вы сохраните кастомную тему с темной, но главное меню будет
                  использовать палитру темной темы
                </span>
              </div>
              <SwitchBtn
                size='mini'
                ...
                onChange={() =>
                  settings.changeSwitchBtn(CONFRONTATION_WITHOUT_MENU)
                }
                disabled={
                  !settings.switchBtn[DARK_THEMES] ||
        ...
        <li className='clause'>
          <div className='tuning-control with-description'>
            <div className='text-info-detail'>
              ...
              <span className='description'>
                Левая боковая панель будет увеличиваться при изменении размеров
                окна
              </span>
            </div>
            <SwitchBtn
