          ...
          <div className='tuning-control'>
            <div className='text-info-detail'>
              ...
              <span className='description'>
                При двойной аутентификации Вы будете получать код подтверждения
                на почту
              </span>
            </div>
            <SwitchBtn
        ...
        <li className='clause'>
          <div className='tuning-control direction-column'>
            <div className='text-info-detail'>
              ...
              <span className='description'>
                Здесь отображается список последних входимых устроств через Ваш
                аккаунт
              </span>
            </div>

            <Table
              newClass={classnames('table-information backlight', {
                hidden: !inputDevices.length,
              })}
            >
              {inputDevices &&
                inputDevices.map((data, i) => (
                  <Table.Row
                    key={i}
                  ...
                  >
                    ...
                    <Table.Ceil>
                      ...
                      {data.ip === localStorage.getItem('ip') && (
                        <BadgeMini text='Ваш IP' newClass='primary' />
                      )}
                    </Table.Ceil>
        ...
        <li className='clause'>
          <div className='tuning-control'>
            <div className='text-info-detail'>
              ...
              <span className='description'>
                Вы перейдете на сторонний сайт, и сможете узнать более подробную
                информацию о данных IP-адресах
              </span>
            </div>
            <a
              href='https://2ip.ru/whois/'
