...
export const Webcam = () => {
    ...
    return (
        <div className="webcam">
            ...
            <ul className={classnames("clauses-tining transition", {'disabled': !settings.switchBtn[CONNECT_MICROPHONE]})}>
                    ...
                    <div className="tuning-control with-description">
                        <div className='tuning-control__wrapper-column w-50 align-items-center flex-wrap'>
                            ...
                            <Range
                                ...
                                max={100}
                                step={1}
                                defaultValue={settings.microphoneAndCamera.microphone.volumes['volume-input']} 
                                onChange={value => settings.onChooseVolumeDevices('volume-input', value)}
                                marks={{50:'50%'}}
                        ...
                        <div className='tuning-control__wrapper-column w-50 align-items-center flex-wrap'>
                            ...
                            <Range 
                                ...
                                max={100}
                                step={1}
                                defaultValue={settings.microphoneAndCamera.microphone.volumes['volume-output']}
                                onChange={value => settings.onChooseVolumeDevices('volume-output', value)}
                                marks={{50:'50%'}}
                                style={{marginBottom: '1em'}}
                            />
                        </div>
                ...
                <li className='clause'>
                    <div className="tuning-control">
                        ...
                        <Select 
                            ...
                            value={settings.microphoneAndCamera.microphone.devices['device-input'].label}
                        />
                    </div>
                </li>
                ...
                <li className='clause'>
                    <div className="tuning-control">
                        ...
                        <Select 
                            ...
                            onChange={settings.onChooseMicrophoneAndWebcamera}
                            value={settings.microphoneAndCamera.microphone.devices['device-output'].label}
                        />
                    </div>
                </li>
                ...
                <li className='clause'>
                    <div className="tuning-control">
                        <div className="text-info-detail">
                            ...
                            <span className='description'>Визуализатор звука поможет Вам понять работает ли микрофон или нет</span>
                        </div>
                        <SwitchBtn 
                            size='mini'
                            id='visualization' 
                    ...
                    <div className="tuning-control with-description">
                        <SoundVisualization 
                            isWork={settings.switchBtn[VISUALIZATION]}
                        />
                    </div>
                </li>
            ...
            <ul className={classnames("clauses-tining transition", {'disabled': !settings.switchBtn[CONNECT_WEBCAM]})}>
                ...
                <li className="clause">
                    <div className="tuning-control direction-column">
                        ...
                        <div className={classnames("w-50 preview-webcamera", {'active': settings.isPreviewWebcamera})}>
