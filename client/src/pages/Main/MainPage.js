        ...
        <ContextGetInfo.Provider value={{infoUser, rerender, setRerender, listRequestFriends, createdMyRooms}}>
            ...
            <div 
                className={
                    ...
                    {'dark-theme-locked': settings.switchBtn[CONFRONTATION_WITH_DARK_THEME]},
                    {'confrontation-dart-theme-with-menu': settings.switchBtn[CONFRONTATION_WITHOUT_MENU]},
            ...
            >
                ...
                {(settings.switchBtn[DUAL_AUTHENTICATION] && !settings.switchBtn[PASS_USER] && settings.successfulIdentification) ? <SecuritySection/> : (
                    <>
                        <MainMenu/>
                        <div className={classnames('main-content', {'row-reverse': settings.switchBtn[MIRROR_CONTAINER]})}>
                            {children}
                        </div>
                    </>
                )}
